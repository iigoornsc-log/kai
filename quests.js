...
const arvoreDeSkills = [
    {
        nivel: "NÍVEL I: A Fundação",
        descricao: "Onde a nossa história começou.",
        missoes: [
            ...
            { titulo: "Sincronia Musical", desc: "Descobrir a música favorita do outro.", status: "bloqueado" }
        ]
    },
    {
        nivel: "NÍVEL II: Intimidade & Loucura",
        descricao: "casal e quebrando barreiras.",
        missoes: [
            ...
            { titulo: "Roubo", desc: "Roubar a primeira peça de roupa do outro.", status: "desbloqueado" },
            { titulo: "Ponto Fraco", desc: "Descobrir onde o outro tem mais cócegas.", status: "desbloqueado" },
            { titulo: "Ataque de Risos", desc: "Crise de riso até a barriga doer.", status: "desbloqueado" },
            { titulo: "Intimidade", desc: "Tomar o primeiro banho juntos.", status: "desbloqueado" },
            { titulo: "Aventura Noturna", desc: "Virar a noite juntos.", status: "bloqueado" }
        ]
    },
    {
        nivel: "NÍVEL III: Oficializando o namoro",
        descricao: "A Campanha Principal do nosso romance.",
        missoes: [
            { titulo: "O Grande Passo", desc: "O Pedido de Namoro Oficial.", status: "bloqueado" },
            { titulo: "Assumir pra galera", desc: "Primeira foto oficial de casal nas redes.", status: "desbloqueado" },
            ...
            { titulo: "Cine Privê", desc: "Ir ao cinema e não prestar atenção no filme.", status: "desbloqueado" },
    ...
    {
        nivel: "NÍVEL MÁXIMO:",
        descricao: "O futuro que nos aguarda.",
        missoes: [
